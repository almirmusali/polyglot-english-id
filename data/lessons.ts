...
export const lessons: Lesson[] = [
  ...
  {
    id: 1,
    slug: "kata-ganti-to-be",
    title: "Pelajaran 1 — Kata Ganti & Kata Kerja \"to be\"",
    subtitle: "Saya adalah, kamu adalah, dia adalah …",
    goal: "Menguasai dasar dari semua kalimat bahasa Inggris: kata ganti orang dan bentuk kata kerja \"to be\" (am / is / are).",
    intro:
      "Dalam bahasa Indonesia kita sering mengatakan \"Saya guru\" tanpa kata penghubung. Tetapi dalam bahasa Inggris hampir selalu wajib ada kata kerja. Kata kerja paling penting adalah \"to be\" — yang berarti \"adalah / merupakan\". Bentuknya berubah tergantung pada subjek.",
    grammar: [
      {
        heading: "Kata ganti orang (Personal Pronouns)",
        explanation:
          "Ini adalah \"siapa\" yang melakukan tindakan. Hafalkan tabel ini — Anda akan menggunakannya di setiap pelajaran berikutnya.",
        table: {
          caption: "Kata Ganti Orang",
          columns: ["English", "Bahasa Indonesia", "Pengucapan"],
          rows: [
            ["I", "saya / aku", "ai"],
            ["You", "kamu / Anda / kalian", "yu"],
            ["He", "dia (laki-laki)", "hi"],
            ["She", "dia (perempuan)", "syi"],
            ["It", "ia / itu (benda, hewan)", "it"],
            ["We", "kami / kita", "wi"],
            ["They", "mereka", "dei"],
          ],
        },
      ...
      {
        heading: "Bentuk \"to be\" — am / is / are",
        explanation:
          "\"To be\" berarti \"adalah\". Bentuknya tidak sama untuk semua kata ganti. Ini berbeda dari bahasa Indonesia di mana \"adalah\" tidak berubah.",
        table: {
          caption: "Konjugasi \"to be\" (Present Simple)",
          columns: ["Subjek", "to be", "Contoh"],
          rows: [
            ["I", "am", "I am a student. (Saya seorang pelajar.)"],
            ["You", "are", "You are kind. (Kamu baik.)"],
            ["He", "is", "He is my friend. (Dia teman saya.)"],
            ["She", "is", "She is happy. (Dia bahagia.)"],
            ["It", "is", "It is a book. (Itu sebuah buku.)"],
            ["We", "are", "We are from Jakarta. (Kami dari Jakarta.)"],
            ["They", "are", "They are tired. (Mereka lelah.)"],
          ],
        },
        note:
          "Rumus mudah diingat: I → am, He/She/It → is, You/We/They → are.",
      },
      {
        heading: "Bentuk singkat (Contractions)",
        explanation:
          "Dalam percakapan, bentuk \"to be\" biasanya disingkat. Ini sangat sering Anda dengar.",
        table: {
          caption: "Bentuk lengkap → singkat",
          columns: ["Lengkap", "Singkat"],
          rows: [
            ["I am", "I'm"],
            ["You are", "You're"],
            ["He is", "He's"],
      ...
      },
      {
        heading: "Negasi: not",
        explanation:
          "Untuk membuat kalimat negatif, tambahkan kata \"not\" setelah \"to be\".",
        examples: [
          { en: "I am not tired.", id: "Saya tidak lelah." },
          { en: "She is not at home.", id: "Dia tidak di rumah." },
          { en: "They are not students.", id: "Mereka bukan pelajar." },
        ],
        note: "Bentuk singkat: is not → isn't, are not → aren't. (\"am not\" tidak disingkat menjadi satu kata.)",
      },
      {
        heading: "Pertanyaan",
        explanation:
          "Untuk bertanya, balik urutan: letakkan \"to be\" di depan subjek.",
        examples: [
          { en: "Are you a teacher?", id: "Apakah kamu seorang guru?" },
          { en: "Is he your brother?", id: "Apakah dia saudaramu?" },
          { en: "Am I late?", id: "Apakah saya terlambat?" },
        ],
      },
    ],
    vocabulary: [
      { en: "student", id: "pelajar / mahasiswa", pron: "stiu-dent" },
      { en: "teacher", id: "guru", pron: "ti-cer" },
      { en: "friend", id: "teman", pron: "frend" },
      { en: "name", id: "nama", pron: "neim" },
      { en: "home", id: "rumah", pron: "houm" },
      { en: "happy", id: "bahagia", pron: "hep-pi" },
      { en: "tired", id: "lelah", pron: "taierd" },
      { en: "kind", id: "baik hati", pron: "kaind" },
      { en: "from", id: "dari", pron: "from" },
      { en: "ready", id: "siap", pron: "redi" },
      { en: "busy", id: "sibuk", pron: "bizi" },
      { en: "hungry", id: "lapar", pron: "hang-gri" },
      { en: "late", id: "terlambat", pron: "leit" },
      { en: "doctor", id: "dokter", pron: "dok-ter" },
      { en: "city", id: "kota", pron: "siti" },
    ],
    phrases: [
      { en: "Hello! My name is Andi.", id: "Halo! Nama saya Andi." },
      ...
      { en: "He is my best friend.", id: "Dia teman terbaik saya." },
      { en: "We are ready.", id: "Kami siap." },
    ],
    exercises: [
      {
        type: "fill",
        prompt: "Isi dengan bentuk \"to be\" yang benar (am / is / are).",
        question: "She ___ a doctor.",
        answer: "is",
      },
      {
        type: "fill",
        prompt: "Isi dengan bentuk \"to be\" yang benar.",
        question: "We ___ from Bali.",
        answer: "are",
      },
      {
        type: "fill",
      ...
      },
      {
        ...
        question: "Mereka adalah teman saya.",
